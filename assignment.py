...
import math
import unittest
from functions import ClassifierFunction, FindIdealFunction,CreateIdealFunctionHeader, toSql,utility,DataDescription
...
#### Frist step: Read the CSV files and store them as objects
    ...
    toSql(obj=ideal_input,fileName="/databaseideal", suffix=" (ideal function)")
...
df_results_best_function= pd.DataFrame({
    ...
    index=['Best_Function','Least Squares',"MSE",'MaxDeviation',"ClassificationThreshold"])
...
# print out the results of the classifier
